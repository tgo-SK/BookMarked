...
public class EmailSenderAdmin{
	public static class MailPasswordAuthenticator extends Authenticator{
		public static String senderEmailAdmin;
		public static String senderEmailPasswordAdmin;
         
		public PasswordAuthentication getPasswordAuthentication(){
			return new PasswordAuthentication(senderEmailAdmin,senderEmailPasswordAdmin);
		}
	}
	...
	public static void sendEmail(String email,String subject,String msg){
		...
		try{
			message.setFrom(MailPasswordAuthenticator.senderEmailAdmin);
